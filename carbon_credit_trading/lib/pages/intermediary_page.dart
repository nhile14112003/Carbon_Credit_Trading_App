  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
        ...
        child: Scaffold(
          ...
          body: FutureBuilder<AppUserDTO?>(future: userControllerApi.viewUser(currentUserId!), builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return const Center(child: CircularProgressIndicator());
            } else if (snapshot.hasError) {
              return const Center(child: Text('Có lỗi xảy ra khi tải thông tin người dùng'));
