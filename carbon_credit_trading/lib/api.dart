...
part 'api/authentication_resource_api.dart';
part 'api/buyer_controller_api.dart';
part 'api/file_controller_api.dart';
part 'api/mediator_audit_controller_api.dart';
part 'api/password_reset_resource_api.dart';
part 'api/registration_resource_api.dart';
part 'api/seller_controller_api.dart';
